...
macro square16(col, row, color) {
  Set_Fill_Color ({color} << 16) | {color} // Set Fill Color: PACKED COLOR 32B R8G8B8A8 Pixel
  Fill_Rectangle (({row} * 20) + (({col} + 1) * 20)) << 2, ({row} * 20) << 2, (({row} * 20) + ({col} * 20)) << 2, ({row} * 20) << 2
}
...
No_Op 
  ...
  Fill_Rectangle 20<<2,20<<2, 0<<2,0<<2 
  No_Op 
  No_Op 

  square16(0, 1, PALE_TURQUOISE)
  Set_Fill_Color (PALE_TURQUOISE << 16) | PALE_TURQUOISE
  Fill_Rectangle 40<<2,20<<2,0<<2,20<<2
  No_Op 
  No_Op 
  
  //Set_Fill_Color (AQUA << 16) | AQUA
  //Fill_Rectangle 319<<2,18<<2, 301<<2,0<<2 //Fill_Rectangle 20<<2,20<<2,5<<2,5<<2
  //No_Op 
...
dw 0x0
  ...
  Fill_Rectangle 80<<2,20<<2,100<<2,1<<2
  ...
  Fill_Rectangle 80<<2,40<<2, 21<<2,1<<2
